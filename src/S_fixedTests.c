...
int main(int argc, char* argv[]) {
    ...
    AssertEq(13.0, Fadd(FxFrom(4), FxFrom(9)));
    AssertEq(-3.0, Fsub(FxFrom(5), FxFrom(8)));
    AssertEq(42.0, Fmul(FxFrom(6), FxFrom(7)));
    AssertEq(7.0 / 6.0, Fdiv(FxFrom(7), FxFrom(6)));
    AssertEq(1.5, Fmod(FxFrom(7.5), FxFrom(6)));

    AssertEq(4.5, Fhalf(FxFrom(9)));
    AssertEq(18.0, Fdouble(FxFrom(9)));
    ...
    AssertEq(81.0, Fsqr(FxFrom(9)));
    AssertEq(9.0, Fsqrt(FxFrom(81)));
